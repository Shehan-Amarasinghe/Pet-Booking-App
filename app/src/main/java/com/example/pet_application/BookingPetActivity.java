...
public class BookingPetActivity extends AppCompatActivity {
...
//        timepicker
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BookingPetActivity.this,DogDetailsActivity.class));
            }
        });
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Database db = new Database(getApplicationContext(), "Pet Booking", null, 1);
                ...
                if (db.checkAppointmentExists(username, title + "=>" + fullname, address, contact, dateButton.getText().toString(), timeButton.getText().toString()) == 1) {
                    Toast.makeText(getApplicationContext(), "Your booking already booked", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(BookingPetActivity.this, HomeActivity.class));
                } else {
